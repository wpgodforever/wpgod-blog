<template>
    <div class="item-container">
      ...
      <div class="right flex-col">
        <div class="right-name">{{ reply_user_id.username + ' 回复 ' + get_reply_user_id.username }}</div>
  ...
  const { reply_user_id, replyContent, get_reply_user_id, reply_common_id, } = toRefs(props.replyInfo);
